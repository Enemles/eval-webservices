...
export class GqlAuthGuard implements CanActivate {
    ...
    async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        if (isPublic) {
            this.logger.debug('Opération GraphQL publique, pas besoin d\'authentification');
            return true;
        }
        ...
        this.logger.debug(`Vérification du token pour l'opération GraphQL: ${info.fieldName}`);
